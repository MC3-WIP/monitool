...
extension OwnerReviewView{
    ...
    @ViewBuilder
    func reviseButton(task: Task) -> some View{
        let taskViewModel = TaskViewModel()
        
        Button(action: {
            taskViewModel.updateStatus(task, TaskStatus.revise.title)
    ...
    @ViewBuilder
    func approveButton(task: Task) -> some View{
        let taskViewModel = TaskViewModel()
        
        Button(action: {
            taskViewModel.updateStatus(task, TaskStatus.completed.title)
            self.presentationMode.wrappedValue.dismiss()
        }){
            HStack{
