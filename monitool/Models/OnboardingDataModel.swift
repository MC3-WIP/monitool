...
extension OnboardingDataModel{
    static var dataOnboarding: [OnboardingDataModel] = [
        ...
        OnboardingDataModel(image: "MonitorIllustration", titleText: "Monitor", descText: "Monitor your employee works result with ease"),
        OnboardingDataModel(image: "ReviewIllustration", titleText: "Review", descText: "You can review and let your employee validates their peer works result on site")
    ]
}
